  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 relative">
        ...
        <div className="absolute right-0 top-0 h-20 w-20 bg-blue-100 rounded-full opacity-50 -z-10 translate-x-1/2 -translate-y-1/4"></div>
        <div className="absolute left-0 bottom-0 h-12 w-12 bg-blue-200 rounded-full opacity-40 -z-10 -translate-x-1/3 translate-y-1/2"></div>
      </div>
