...
import { SUBSCRIPTION_PLANS, SubscriptionPlan } from "@/lib/domains/subscription.domain";
...
export default async function SubscriptionPage({
  ...
  const showPremiumRequired = searchParams.error === "premium-required";

  return (
    <div 
      className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-8 px-4"
    >
          ...
          {showPremiumRequired && (
            <Alert className="mb-6 bg-yellow-50 border-yellow-200">
              <AlertDescription className="text-yellow-800">
                This feature requires a Premium subscription. Please upgrade your plan to access AI tools.
              </AlertDescription>
            </Alert>
          )}
      ...
      {currentPlan === SubscriptionPlan.FREE && (
        <div className="mt-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Upgrade to Premium to unlock AI Mock Interviews, Resume Analysis, and more!
          </p>
        </div>
      )}
    </div>
